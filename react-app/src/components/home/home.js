                        ...
                        <div className="ads-container-right">
                            ...
                            <div className="ads-for-items">
                                <div className="ad-container">
                                    <Link to="/items/12" className="ad-item-link" onClick={() => window.scrollTo(0, 0)}>
                                ...
                                <div className="ad-container">
                                    <Link to="/items/3" className="ad-item-link" onClick={() => window.scrollTo(0, 0)}>
                                ...
                                <div className="ad-container">
                                    <Link to="/items/10" className="ad-item-link" onClick={() => window.scrollTo(0, 0)}>
                                ...
                                <div className="ad-container">
                                    <Link to="/items/8" className="ad-item-link" onClick={() => window.scrollTo(0, 0)}>
