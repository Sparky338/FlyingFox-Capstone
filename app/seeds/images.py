...
def seed_images():
    ...
    db.session.add(Prince4)
    db.session.add(Sideshow)
    db.session.add(Sideshow2)
    db.session.add(Sideshow3)
    db.session.add(Sideshow4)
    db.session.add(Sideshow5)
    db.session.add(Beast)
    db.session.add(Beast2)
    db.session.add(Beast3)
    db.session.add(Beast4)
    db.session.add(Beast5)
    db.session.add(Beast6)
    db.session.add(Beast7)
    db.session.add(Beast8)
    db.session.add(Beast9)
    db.session.add(Racer)
    db.session.add(Racer2)
    db.session.add(Racer3)
    ...
    db.session.add(Mutant4)
    db.session.add(Mutant5)
    db.session.add(Mutant6)
    db.session.add(SFG)
    db.session.add(SFG2)
    db.session.add(SFG3)
    db.session.add(SFG4)
    ...
    db.session.add(Haymaker2)
    db.session.add(Haymaker3)
    db.session.add(Haymaker4)
    db.session.add(Haymaker5)
    db.session.add(Epicenter)
    db.session.add(Epicenter2)
    db.session.add(Epicenter3)
